...
- ### 잠정적으로 개발을 중단합니다.
이거 개발하는것 보다 NixOS 를 사용하는것이 더 쉽고 편리하다고 느꼈습니다.<br>
이후에 풀잎리눅스의 원류를 아치리눅스에서 NixOS 로 바꾸어 <br>
개발을 계속 할지에 대해서도 생각해 보았는데 <br>
굳이 그럴 필요가 있을까 싶기도 합니다.<br>
풀잎리눅스를 만들면서 이것저것 공부가 많이 되었습니다.<br>
잠깐 이라도 풀잎리눅스를 사용해 주신분들께 감사드립니다.<br>
